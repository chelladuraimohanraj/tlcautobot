...
class sheet:
    def __init__(self):
        ...
        self.creds = ServiceAccountCredentials.from_p12_keyfile('chelladuraimohanraj@gmail.com','ubuntu/creds.p12',private_key_password='notasecret',scopes=self.scope,)
